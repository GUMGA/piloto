define([], function() {
  ...
  ModalEntregaController.$inject = ['$scope', 'gumgaController', '$uibModal', '$uibModalInstance', 'gumgaController','entity'];

  function ModalEntregaController($scope, gumgaController, $uibModal, $uibModalInstance, gumgaController, entity) {
  
  	   $scope.itempedidoproduto = {};
  	   $scope.itempedidoproduto.data = angular.copy(entity) || {};

...
@RestController
@RequestMapping("/api/itempedidoproduto")
public class ItemPedidoProdutoAPI extends GumgaAPI<ItemPedidoProduto, Long> {


    @Autowired
    public ItemPedidoProdutoAPI(GumgaService<ItemPedidoProduto, Long> service) {
        super(service);
    }

    @Override
    public ItemPedidoProduto load(@PathVariable Long id) {
        return ((ItemPedidoProdutoService)service).loadItemPedidoProdutoFat(id);
    }

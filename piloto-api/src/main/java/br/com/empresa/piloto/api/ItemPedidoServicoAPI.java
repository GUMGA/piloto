...
@RestController
@RequestMapping("/api/itempedidoservico")
public class ItemPedidoServicoAPI extends GumgaAPI<ItemPedidoServico, Long> {


    @Autowired
    public ItemPedidoServicoAPI(GumgaService<ItemPedidoServico, Long> service) {
        super(service);
    }
